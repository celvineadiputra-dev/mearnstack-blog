            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active">
                        ...
                        <ul
                            class="collapse submenu recent-submenu mini-recent-submenu list-unstyled show"
                            id="starter-kit"
                            data-parent="#accordionExample">
                            <li class="active">
                                <a href="starter_kit_blank_page.html">
                                    {" "}
                                    Blank Page{" "}
                                </a>
                            </li>
                            <li>
                                <a href="starter_kit_breadcrumb.html">
                                    {" "}
                                    Breadcrumb{" "}
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="starter_kit_alt_menu.html">
                                    {" "}
                                    Alternate Menu{" "}
                                </a>
                            </li>
